...
#| label: wrap-4
#| echo: false
checkdown::check_question(answer = "Both (A) and (B)",
                          options = c("The current sample size $n$ is already large.",
                                      "The new data value is close to the current sample mean.",
                                      "The new data value is smaller than the current sample minimum.",
                                      "The new data value is greater than the current sample maximum.",
                                      "Both (A) and (B)",
                                      "Both (C) and (D)"),
                          button_label = "Check Your Answer", 
                          type = "radio")
...
#### Problem 5 
In the dataset of [`study-hours.csv`](8-intro-to-stats/study-hours.csv), let us focus on the categorical variable of $\texttt{gender}$ where $\texttt{F}$ denotes a female student and $\texttt{M}$ denotes a male student.



```{webr}
#| label: wrap-5-read
#| exercise: ex_wrap_5_read
#| caption: "Use R to read in the data as study_hours"


```


::: {.solution exercise="ex_wrap_5_read"}
...
```{webr}
#| label: wrap-5-a
#| exercise: ex_wrap_5_a
#| caption: "Use R to find the sample size"


```


::: {.solution exercise="ex_wrap_5_a"}
...
```{webr}
#| label: wrap-5-b
#| exercise: ex_wrap_5_b
#| caption: "Use R to find the value"


```


::: {.solution exercise="ex_wrap_5_b"}
...
```{webr}
#| label: asn-5-read
#| exercise: ex_asn_5_read
#| caption: "Use R to read in the data as king"


```


::: {.solution exercise="ex_asn_5_read"}
...
a. Estimate the probability of giving a birth to a boy when a woman is 
