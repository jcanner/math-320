...
#| label: read-study2
#| include: false
study2 <- read_csv("../note-outlines/1-intro-r-quarto/data/study2.csv", show_col_types = FALSE)
```
...
For example, we could load a version of our data on hours spent studying in week 1 and week 2 that has three columns, one for day and one for each week. 

```{r}
#| label: read-study
#| echo: false
study <- read_csv("../note-outlines/1-intro-r-quarto/data/study.csv", show_col_types = FALSE)
study
```
