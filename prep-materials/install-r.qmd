...
![](images/week-1/r-version.png){fig-alt="A screenshot of what version of R should appear when you open RStudio. The version reads 'R version 4.6.1 (2026-06-25) -- 'Happy Hop''."}
:::{.callout-important}
## Check your R Version
If the version **is not** 4.6.1, you need to update your version of R! The simplest way to do this is to follow the instructions below to install R.
:::
